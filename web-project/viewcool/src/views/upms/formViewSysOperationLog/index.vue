      ...
      <el-row :gutter="20">
        ...
        <el-col :span="24">
          <el-form-item label="请求地址：">
            ...
            <el-tag
              ...
              :type="
                formData.formViewSysOperationLog.requestMethod === 'GET' ? 'success' : 'primary'
              "
            >
        ...
        <el-col :span="24">
          <el-form-item label="请求参数：">
            <JsonViewer
              v-model="formData.formViewSysOperationLog.requestArguments"
              :expand-depth="5"
              boxed
            />
          </el-form-item>
        ...
        <el-col :span="24">
          <el-form-item label="返回结果：">
            <JsonViewer
              v-model="formData.formViewSysOperationLog.responseResult"
              :expand-depth="5"
              boxed
            />
          </el-form-item>
...
export default {
  ...
  mounted() {
    ...
    this.formData.formViewSysOperationLog.requestArguments =
      JSON.parse(this.rowData.requestArguments) || {};
    this.formData.formViewSysOperationLog.responseResult =
      JSON.parse(this.rowData.responseResult) || {};
  }
};
</script>
