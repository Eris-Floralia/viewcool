    ...
    <el-row style="height: 440px">
      <el-col :span="24">
        ...
        >
          ...
          <vxe-column title="状态">
            <template slot-scope="scope">
              <el-tag :type="getUserStatusType(scope.row.userStatus)" :size="defaultFormItemSize">{{
...
export default {
  ...
  methods: {
    ...
    onSetUser() {
      ...
      SysDataPermController.addDataPermUser(this, params)
        .then(res => {
    ...
    loadSysUserData(params) {
      ...
      this.$refs.userTable.clearCheckboxRow();
      return new Promise((resolve, reject) => {
        SysDataPermController.listNotInDataPermUser(this, params)
          .then(res => {
            resolve({
  ...
  computed: {
    getContextHeightStyle() {
      return [{ height: this.getClientHeight - 142 + 'px' }];
    },
