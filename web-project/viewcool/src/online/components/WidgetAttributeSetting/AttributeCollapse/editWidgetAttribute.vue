<template>
  <el-collapse-item :title="attributeItem.name" class="attribute-collapse">
    <el-row slot="title" class="attribute-item-title">
      <span style="padding: 0px 16px;">{{attributeItem.name}}</span>
    </el-row>
    ...
    <el-slider v-if="inputWidgetType === SysCustomWidgetType.Slider"
      style="width: 95%; margin-left: 5px;" size="small"
      :min="attributeItem.min"
      :max="attributeItem.max"
      :value="value" @input="onValueChange"
      v-bind="attributeProps"
...
<style scoped>
  .attribute-collapse ::v-deep .el-textarea__inner {
