...
import viewcool.common.core.config.BaseMultiDataSourceConfig;
import viewcool.common.core.config.DynamicDataSource;
...
@MapperScan(value = {"viewcool.webadmin.*.dao", "viewcool.common.*.dao"})
