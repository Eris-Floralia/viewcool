package viewcool.common.log.aop;
...
import viewcool.common.core.util.IpUtil;
import viewcool.common.core.util.MyCommonUtil;
import viewcool.common.log.annotation.IgnoreResponseLog;
import viewcool.common.log.annotation.OperationLog;
import viewcool.common.log.config.OperationLogProperties;
...
public class OperationLogAspect {
     ...
     * 所有controller方法。
     */
    @Pointcut("execution(public * viewcool..controller..*(..))")
