package viewcool.common.core.aop;

import viewcool.common.core.annotation.MyDataSourceResolver;
import viewcool.common.core.util.DataSourceResolver;
import viewcool.common.core.config.DataSourceContextHolder;
...
public class DataSourceResolveAspect {
     ...
     */
    @Pointcut("execution(public * viewcool..service..*(..)) " +
            "&& @target(viewcool.common.core.annotation.MyDataSourceResolver)")
