...
public abstract class BaseUpDownloader {
    ...
    public String makeFullPath(
        ...
        if (StringUtils.isNotBlank(modelName)) {
            uploadPathBuilder.append(StrUtil.SLASH).append(modelName);
        }
        if (StringUtils.isNotBlank(fieldName)) {
            uploadPathBuilder.append(StrUtil.SLASH).append(fieldName);
        }
    ...
    protected void fillUploadResponseInfo(
        ...
        uri = StringUtils.removeEnd(uri, StrUtil.SLASH);
     ...
     * @return 文件的输入流。
     */
    public abstract InputStream getInputSream(
            String rootBaseDir,
            String modelName,
            String fieldName,
            String fileName,
    ...
    protected UploadResponseInfo verifyUploadArgument(MultipartFile uploadFile) {
