package viewcool.common.dict.service.impl;
...
import viewcool.common.core.annotation.MyDataSourceResolver;
...
import viewcool.common.core.object.TokenData;
import viewcool.common.core.util.DefaultDataSourceResolver;
import viewcool.common.core.util.RedisKeyUtil;
import viewcool.common.dict.constant.GlobalDictItemStatus;
import viewcool.common.dict.dao.TenantGlobalDictMapper;
import viewcool.common.dict.model.TenantGlobalDict;
import viewcool.common.dict.model.TenantGlobalDictItem;
import viewcool.common.dict.service.TenantGlobalDictItemService;
import viewcool.common.dict.service.TenantGlobalDictService;
...
public class TenantGlobalDictServiceImpl
    ...
    @Override
    public boolean existDictItemListFromCache(String dictCode, String itemIds) {
        TenantGlobalDict tenantGlobalDict = this.getTenantGlobalDictFromCache(dictCode);
        Set<Serializable> itemIdSet = new HashSet<>(StrUtil.split(itemIds, ","));
        List<TenantGlobalDictItem> items = this.getGlobalDictItemListFromCache(tenantGlobalDict, itemIdSet);
        return itemIdSet.size() == items.size();
    }
