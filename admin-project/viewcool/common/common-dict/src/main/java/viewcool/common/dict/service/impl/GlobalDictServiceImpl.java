...
import viewcool.common.dict.dao.GlobalDictMapper;
import viewcool.common.dict.model.GlobalDict;
import viewcool.common.dict.model.GlobalDictItem;
import viewcool.common.dict.service.GlobalDictItemService;
...
public class GlobalDictServiceImpl extends BaseService<GlobalDict, Long> implements GlobalDictService {
    ...
    public boolean existDictItemListFromCache(String dictCode, String itemIds) {
        ...
        List<GlobalDictItem> items = this.getGlobalDictItemListFromCache(dictCode, itemIdSet);
